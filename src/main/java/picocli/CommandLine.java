/*
   The source code of this class has been copied'n'pasted from
   "picocli" project

       https://github.com/remkop/picocli

   The idiom "Include as source (it’s only one file)" is greatly
   encouraged by the author of the library. Indeed, it simplifies
   building of custom applications significantly, especially in
   case of non-permanent test task like this one.

   Perhaps, the downside of such an approach is sligly increased
   compilation time. For example, if you're testing your CLI
   application by running via Maven (e.g. with aid of Exec Maven
   plugin) you'll get this source code re-compiled. But once the
   executable JAR is assembled, it's not an issue.
*/
...
public class CommandLine {
    ...
    public static final String VERSION = "4.0.0-alpha-1-SNAPSHOT";
